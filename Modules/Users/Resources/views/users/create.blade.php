...
@section('title', __('users::users.add_user'))
                ...
                <div class="card-header border-0 bg-transparent pt-4">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h5 class="card-title mb-0 fs-18 fw-bold text-primary">{{ __('users::users.add_user') }}</h5>
                            <p class="text-muted mb-0 fs-13">
                                {{ __('users::users.create_user_description' ?? 'Fill in the information below to create a new system user.') }}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('users.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('users::users.enter_first_name' ?? 'Enter first name') }}">
                                            @error('first_name')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('users::users.enter_last_name' ?? 'Enter last name') }}">
                                            @error('last_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="{{ __('users::users.enter_username' ?? 'username') }}">
                                            </div>
                                            @error('username')
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4 mt-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="password"
                                                class="form-label fw-semibold">{{ __('users::users.password') }} <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="password_confirmation"
                                                class="form-label fw-semibold">{{ __('users::users.confirm_password') }}
                        ...
                        <div class="mt-4 pt-4 border-top text-{{ app()->getLocale() == 'ar' ? 'start' : 'end' }}">
                            ...
                            <button type="submit" class="btn btn-primary px-5 fw-bold">
                                <i class="ri-save-line align-bottom me-1"></i> {{ __('users::users.create_user') }}
                            </button>
                        </div>
                    </form>
                </div>
