                                                    ...
                                                    <div class="avatar-group hstack gap-n1">
                                                        @foreach ($group->members->take(5) as $member)
                                                            <div class="avatar-group-item shadow-sm border border-2 border-white rounded-circle"
                                                                ...
                                                                <div class="avatar-xxs">
                                                                    ...
                                                                    @else
                                                                        <span
                                                                            class="avatar-title rounded-circle bg-{{ $member->pivot->is_leader ? 'warning' : 'info' }} text-white fs-10 fw-bold">
                                                                            {{ substr($member->first_name, 0, 1) }}{{ substr($member->last_name, 0, 1) }}
                                                                        </span>
                                                                    @endif
                                                                    @if ($member->pivot->is_leader)
                                                                        <span
                                                                            class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-warning p-1 border border-white shadow-sm"
                                                                            style="margin-top: -1px; margin-left: -1px;">
                                                                            <i
                                                                                class="ri-vip-crown-fill text-white fs-8"></i>
                                                                        </span>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        ...
                                                        @if ($group->members->count() > 5)
                                                            <div class="avatar-group-item">
                                                                <div class="avatar-xxs">
                                                                    <div
                                                                        class="avatar-title rounded-circle bg-primary-subtle text-primary fs-10 fw-bold border border-2 border-white">
                                                        ...
                                                        @if ($group->members->count() == 0)
                                                            <span
                                                                class="text-muted fs-12 fw-medium opacity-50">{{ __('tickets::messages.none') }}</span>
                                                        @endif
                                                    </div>
                                                </td>
                                                <td>
                                                    @if ($group->is_default)
                                                        <span
                                                            class="badge bg-success-subtle text-success fs-11 px-3 py-1 rounded-pill">
                                                            <i class="ri-checkbox-circle-fill me-1 align-middle"></i>
                                                            {{ __('tickets::messages.active') }}
                                                        </span>
                                                    @else
                                                        <span
                                                            class="text-muted opacity-50 small italic">{{ __('tickets::messages.none') }}</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        @can('tickets.groups.update')
                                                        ...
                                                        @if ($pendingDeletions > 0)
                                                            ...
                                                            @can('tickets.delete_requests.manage')
                                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                    ...
                                                                    <button class="btn btn-warning btn-sm position-relative"
                                                                        onclick="openDeleteRequests('Modules\\Tickets\\Domain\\Models\\TicketGroup', {{ $group->id }})">
                                                            ...
                                                            @endcan
                                                        @else
                                                            @canany(['tickets.groups.delete',
                                                                'tickets.groups.delete_requires_approval'])
                                                                @can('tickets.groups.delete')
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        data-bs-trigger="hover" data-bs-placement="top"
                                                                        title="Remove">
                                                                        <button class="btn btn-soft-danger btn-sm remove-item-btn"
                                                                            onclick="deleteItem('{{ route('admin.tickets.groups.destroy', $group->id) }}')">
                                                                            <i class="ri-delete-bin-fill"></i>
                                                                        </button>
                                                                    </li>
                                                                @elsecan('tickets.groups.delete_requires_approval')
                                                                    <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                        data-bs-trigger="hover" data-bs-placement="top"
                                                                        title="Request Deletion">
                                                                        <button class="btn btn-soft-warning btn-sm"
                                                                            onclick="deleteItem('{{ route('admin.tickets.groups.destroy', $group->id) }}', true)">
                                                                            <i class="ri-delete-bin-fill"></i>
                                                                        </button>
                                                                    </li>
                                                                @endcan
                                                ...
                                                <td colspan="5" class="text-center py-5">
                                                    <div class="noresult">
                                                        <div class="text-center">
                                                            ...
                                                            <h5 class="mt-2">{{ __('tickets::messages.no_data_found') }}
                                                            </h5>
        ...
        <div class="modal fade overflow-hidden" id="addGroupModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form action="{{ route('admin.tickets.groups.store') }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        <div class="modal-body p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label fw-bold"><i class="ri-edit-2-line me-1 text-primary"></i>
                                        ...
                                        <div class="form-text text-muted small">
                                            {{ __('tickets::messages.group_name_help') }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label fw-bold"><i class="ri-team-line me-1 text-primary"></i>
                                            {{ __('tickets::messages.members') }}</label>
                                        <select name="members[]" class="form-select select2-modal" multiple
                                            id="add_members_select"
                                            data-placeholder="{{ __('tickets::messages.members') }}">
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}">{{ $user->full_name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="form-text text-muted small">
                                            {{ __('tickets::messages.group_members_help') }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label fw-bold"><i
                                                class="ri-vip-crown-line me-1 text-primary"></i>
                                            {{ __('tickets::messages.leader') }}</label>
                                        <select name="leader_id" class="form-select select2-modal" id="add_leader_select"
                                            data-placeholder="{{ __('tickets::messages.none') }}">
                                            <option value="">{{ __('tickets::messages.none') }}</option>
                                        </select>
                                        <div
                                            class="alert alert-info border-0 bg-info bg-opacity-10 text-info fs-12 mt-2 mb-0 p-2">
                                            <i class="ri-information-line me-2 align-middle"></i>
                                            {{ __('tickets::messages.leader_help') }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div
                                        class="p-3 rounded-3 bg-light border border-dashed border-primary border-opacity-10">
                                        <div
                                            class="form-check form-switch form-switch-lg form-switch-success mb-0 d-flex align-items-center px-0">
                                            <input class="form-check-input ms-0 me-3" type="checkbox" name="is_default"
                                                value="1" id="addDefaultSwitch">
                                            <label class="form-check-label fw-bold text-dark fs-14 mb-0 cursor-pointer"
                                                for="addDefaultSwitch">{{ __('tickets::messages.default') }}</label>
                                        </div>
                                        <div class="form-text text-muted small mt-2">
                                            {{ __('tickets::messages.group_default_help') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="editGroupForm" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="modal-body p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label fw-bold"><i class="ri-edit-2-line me-1 text-info"></i>
                                            {{ __('tickets::messages.name') }}</label>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label fw-bold"><i class="ri-team-line me-1 text-info"></i>
                                            {{ __('tickets::messages.members') }}</label>
                                        <select name="members[]" id="edit_members" class="form-select select2-modal"
                                            multiple data-placeholder="{{ __('tickets::messages.members') }}">
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}">{{ $user->full_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-0">
                                        <label class="form-label fw-bold"><i class="ri-vip-crown-line me-1 text-info"></i>
                                            {{ __('tickets::messages.leader') }}</label>
                                        <select name="leader_id" class="form-select select2-modal"
                                            id="edit_leader_select"
                                            data-placeholder="{{ __('tickets::messages.none') }}">
                                            <option value="">{{ __('tickets::messages.none') }}</option>
                                        </select>
                                        <div
