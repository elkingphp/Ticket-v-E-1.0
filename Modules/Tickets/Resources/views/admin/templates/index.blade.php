                ...
                <div class="table-responsive table-card mb-1">
                    <table class="table align-middle table-nowrap" id="templateTable">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                <td>
                                    <span class="badge bg-primary-subtle text-primary text-uppercase">{{ $template->event_key }}</span>
                                </td>
                                <td class="fw-medium">{{ $template->subject }}</td>
                                <td>
                                    <div class="text-muted">
                                        <i class="ri-calendar-event-line align-middle me-1"></i>{{ $template->updated_at->format('Y-m-d H:i') }}
                                    </div>
                                </td>
                                <td>
                                    <ul class="list-inline hstack gap-2 mb-0">
                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{ __('tickets::messages.preview_template') }}">
                                        ...
                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{ __('tickets::messages.test_email') }}">
                                        ...
                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="{{ __('tickets::messages.lookups.assigned_to') }}">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-soft-info">
                <h5 class="modal-title">{{ __('tickets::messages.edit_template') }}: <span id="template_key_title" class="text-primary text-uppercase"></span></h5>
            ...
            <form id="editTemplateForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ __('tickets::messages.details') }} <span class="badge bg-info-subtle text-info ms-1">HTML</span></label>
                        ...
                        <div class="card bg-light border-0 mt-2">
                            <div class="card-body p-2">
                                <p class="mb-1 text-muted small fw-bold text-uppercase">Variables Available:</p>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ __('tickets::messages.cancel') }}</button>
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header p-3 bg-primary text-white">
                <h5 class="modal-title text-white">
                    ...
                    {{ __('tickets::messages.preview_template') }}: <span id="preview_title" class="text-warning text-uppercase small ms-2"></span>
                </h5>
            ...
            <div class="modal-body p-0">
                <div class="bg-light p-3 border-bottom d-flex align-items-center g-2">
                    <div class="flex-grow-1">
                        ...
                        <span class="text-muted small">Real-time Rendering</span>
                    </div>
                    <div class="btn-group btn-group-sm">
                        <button type="button" class="btn btn-outline-secondary active" id="btn-desktop"><i class="ri-computer-line"></i> Desktop</button>
                        <button type="button" class="btn btn-outline-secondary" id="btn-mobile"><i class="ri-smartphone-line"></i> Mobile</button>
                    </div>
                </div>
                <div class="p-4 bg-white d-flex justify-content-center transition-all" id="preview_content_wrapper" style="min-height: 400px; background-color: #f1f1f1 !important;">
                    <div id="preview_frame_container" style="width: 100%; transition: width 0.3s ease; background: white; box-shadow: 0 5px 15px rgba(0,0,0,0.05);">
                        <iframe id="preview_iframe" style="width: 100%; border: none; min-height: 500px;"></iframe>
                    </div>
                </div>
            </div>
            <div class="modal-footer bg-light">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ __('tickets::messages.cancel') }}</button>
            </div>
        </div>
    </div>
</div>
            ...
            <form id="testMailForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="test_email_input" class="form-control" placeholder="{{ __('tickets::messages.test_email_placeholder') }}" required />
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ __('tickets::messages.cancel') }}</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('editTemplateForm').action = `/admin/tickets/templates/${id}`;
        ...
        previewButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('preview_iframe').src = `/admin/tickets/templates/${id}/preview`;
        ...
        testForm.addEventListener('submit', function(e) {
            ...
            btn.disabled = true;
            btn.innerHTML = '<i class="ri-loader-4-line spinner-border spinner-border-sm me-1"></i> Sending...';
            ...
            .then(data => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Done!',
                    text: data.message || '{{ __("tickets::messages.test_sent_success") }}',
            ...
            .catch(error => {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: error.message || 'Something went wrong while sending the test email.',
