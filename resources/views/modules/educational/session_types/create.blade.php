...
@section('title', __('educational::messages.add_session_type'))
    ...
    <div class="col-xl-8">
        <div class="card border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-soft-info border-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="card-title mb-0 fw-bold">{{ __('educational::messages.add_session_type') }}</h5>
                        <p class="text-muted mb-0 small">إضافة نوع محاضرة جديد (نظري، معمل، ورشة عمل...).</p>
                    </div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('educational.session_types.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control py-2 @error('name') is-invalid @enderror" placeholder="مثال: محاضرة نظري، معمل، ورشة عمل" value="{{ old('name') }}" required>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-0">
                                ...
                                <textarea name="description" class="form-control py-2 @error('description') is-invalid @enderror" rows="3" placeholder="أضف وصفاً مختصراً...">{{ old('description') }}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex align-items-center gap-3 p-3 bg-light rounded">
                                ...
                                <small class="text-muted">سيظهر هذا النوع في قوائم إنشاء المحاضرات عند التفعيل.</small>
                            </div>
                        </div>
