...
@section('title', __('educational::messages.edit_campus'))
    ...
    <div class="col-xl-8">
        <div class="card border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-soft-warning border-0 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="card-title mb-0 fw-bold">{{ __('educational::messages.edit_campus') }}: <span class="text-dark">{{ $campus->name }}</span></h5>
                        <p class="text-muted mb-0 small">تعديل بيانات الفرع / المقر.</p>
                    </div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('educational.campuses.update', $campus->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control py-2 @error('name') is-invalid @enderror" value="{{ old('name', $campus->name) }}" required>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="code" class="form-control py-2 @error('code') is-invalid @enderror" value="{{ old('code', $campus->code) }}" required>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="address" class="form-control py-2 @error('address') is-invalid @enderror" rows="2">{{ old('address', $campus->address) }}</textarea>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-0">
                                ...
                                <select name="status" class="form-select py-2 @error('status') is-invalid @enderror" required>
                                    <option value="active" {{ old('status', $campus->status) == 'active' ? 'selected' : '' }}>{{ __('educational::messages.status_active') }}</option>
                                    <option value="inactive" {{ old('status', $campus->status) == 'inactive' ? 'selected' : '' }}>{{ __('educational::messages.status_inactive') }}</option>
                                </select>
